  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": { "0%, 100%": { boxShadow: "0 0 0 0 hsl(0 100% 71% / 0.4)" }, "50%": { boxShadow: "0 0 20px 6px hsl(0 100% 71% / 0.2)" } },
        ...
        "check-pop": { "0%": { transform: "scale(0)" }, "50%": { transform: "scale(1.3)" }, "100%": { transform: "scale(1)" } },
      },
      animation: {
