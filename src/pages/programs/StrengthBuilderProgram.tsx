...
const StrengthBuilderProgram = () => {
  ...
  if (!isPremium) return <Layout><div className="container py-20"><PremiumGate message="The Strength Builder Program is available for Premium members only." /></div></Layout>;
